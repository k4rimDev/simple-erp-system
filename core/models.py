...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='products/', null=True, blank=True)  # File upload
...
class Order(models.Model):
    ...
    document = models.FileField(upload_to='orders/', null=True, blank=True)  # File upload
